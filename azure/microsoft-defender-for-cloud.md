...
It works with several PaaS services, such as [[azure-app-service]], [[Azure SQL]], and [[azure-storage-account-scripts2]]. It watches for anomalies in the activity logs.
